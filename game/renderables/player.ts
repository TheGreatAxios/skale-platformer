...
class PlayerEntity extends me.Entity {
    ...
    constructor(x: number, y: number, settings: any) {
        ...
        sprite.addAnimation("stand", [{ name: "walk0001.png", delay: 100 }]);
        sprite.addAnimation("walk",  [{ name: "walk0001.png", delay: 100 }, { name: "walk0002.png", delay: 100 }, { name: "walk0003.png", delay: 100 }]);
        sprite.addAnimation("jump",  [{ name: "walk0004.png", delay: 150 }, { name: "walk0005.png", delay: 150 }, { name: "walk0006.png", delay: 150 }, { name: "walk0002.png", delay: 150 }, { name: "walk0001.png", delay: 150 }]);
     ...
     * colision handler
     */
    onCollision(response: { overlapV: { y: number; x: number; }; overlap: number; }, other: { body: { collisionType: any; }; type: string; isMovingEnemy: any; }) {
     ...
     */
    hurt() {
        var sprite = this.renderable as me.Sprite;
